...
const ExpenseList = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`http://booking-frontend-swart.vercel.app/api/expenses/${id}`);
  ...
  const handleViewReceipt = (receiptUrl) => {
    setSelectedReceipt(`${'http://booking-frontend-swart.vercel.app'}${receiptUrl}`);
  };
  ...
  useEffect(() => {
    const fetchExpenses = async () => {
      try {
        ...
        const res = await axios.get('http://booking-frontend-swart.vercel.app/api/expenses', { params });
