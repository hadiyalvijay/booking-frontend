  ...
  useEffect(() => {
    const fetchSummaryData = async () => {
      try {
        ...
        const revenueRes = await axios.get('https://booking-backend-steel.vercel.app/api/payments', { headers });
        const expensesRes = await axios.get('https://booking-backend-steel.vercel.app/api/expenses', { headers });
        const bookingsRes = await axios.get('https://booking-backend-steel.vercel.app/api/bookings', { headers });
